...
@section('content')
{{-- Formulario para editar carrera existente --}}
<h1 class="text-2xl font-semibold text-blue-700 mb-4">Editar carrera</h1>

<form class="bg-white border rounded-xl p-6 max-w-2xl" method="POST" action="{{ route('careers.update', $career->id) }}">
  @csrf
  @method('PUT')
  ...
  <label class="block mb-4">
    ...
    <input type="text" name="nombre" value="{{ old('nombre', $career->nombre) }}"
